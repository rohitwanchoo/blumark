...
<head>
    ...
    <title><?php echo e(config('app.name', 'PDF Watermark Platform')); ?> - Secure Document Protection</title>
...
<body class="font-sans antialiased text-gray-900">
            ...
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <div class="flex items-center space-x-4">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('dashboard')); ?>" class="inline-flex items-center px-5 py-2.5 bg-primary-600 hover:bg-primary-700 text-white text-sm font-semibold rounded-lg transition-all duration-200 shadow-lg shadow-primary-600/25">
                            Dashboard
                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="text-gray-300 hover:text-white text-sm font-medium transition-colors hidden sm:block">
                            Sign In
                        </a>
                        <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center px-5 py-2.5 bg-primary-600 hover:bg-primary-700 text-white text-sm font-semibold rounded-lg transition-all duration-200 shadow-lg shadow-primary-600/25">
                            Get Started
                        </a>
                    <?php endif; ?>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 relative z-10">
            <div class="text-center max-w-4xl mx-auto">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up" style="animation-delay: 0.3s; opacity: 0;">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('dashboard')); ?>" class="inline-flex items-center justify-center px-8 py-4 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-xl transition-all duration-200 shadow-2xl shadow-primary-600/30 hover:shadow-primary-600/40 hover:-translate-y-0.5">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center justify-center px-8 py-4 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-xl transition-all duration-200 shadow-2xl shadow-primary-600/30 hover:shadow-primary-600/40 hover:-translate-y-0.5">
                            <span>Start Free Today</span>
                            <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"/>
                            </svg>
                        </a>
                        <a href="<?php echo e(route('login')); ?>" class="inline-flex items-center justify-center px-8 py-4 bg-white/10 hover:bg-white/20 text-white font-semibold rounded-xl transition-all duration-200 border border-white/20">
                            <span>Sign In</span>
                        </a>
                    <?php endif; ?>
                </div>
    ...
    <section id="how-it-works" class="py-24 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mt-16">
                ...
                <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center justify-center px-8 py-4 bg-dark-900 hover:bg-dark-800 text-white font-semibold rounded-xl transition-all duration-200 shadow-xl hover:-translate-y-0.5">
                ...
                <?php else: ?>
                <a href="<?php echo e(route('dashboard')); ?>" class="inline-flex items-center justify-center px-8 py-4 bg-dark-900 hover:bg-dark-800 text-white font-semibold rounded-xl transition-all duration-200 shadow-xl hover:-translate-y-0.5">
                    <span>Go to Dashboard</span>
                    <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"/>
                    </svg>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-400 text-sm">Files are automatically deleted after <?php echo e(config('watermark.file_retention_days', 7)); ?> days. No data retention.</p>
                            </div>
                        </div>
    ...
    <section class="py-24 bg-gradient-to-r from-primary-600 to-primary-700">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <?php if(auth()->guard()->guest()): ?>
            <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center justify-center px-8 py-4 bg-white hover:bg-gray-100 text-primary-700 font-semibold rounded-xl transition-all duration-200 shadow-xl hover:-translate-y-0.5">
                <span>Start Free Today</span>
                <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"/>
                </svg>
            ...
            <?php else: ?>
            <a href="<?php echo e(route('dashboard')); ?>" class="inline-flex items-center justify-center px-8 py-4 bg-white hover:bg-gray-100 text-primary-700 font-semibold rounded-xl transition-all duration-200 shadow-xl hover:-translate-y-0.5">
                <span>Go to Dashboard</span>
                <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"/>
                </svg>
    ...
    <footer class="bg-dark-900 text-gray-400 py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-4 gap-8 mb-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        ...
                        <li><a href="<?php echo e(route('register')); ?>" class="hover:text-white transition-colors">Create Account</a></li>
                        <?php else: ?>
                        <li><a href="<?php echo e(route('dashboard')); ?>" class="hover:text-white transition-colors">Dashboard</a></li>
                        <li><a href="<?php echo e(route('jobs.index')); ?>" class="hover:text-white transition-colors">My Jobs</a></li>
                        <?php endif; ?>
                    </ul>
                </div>
            </div>
            ...
            <div class="border-t border-dark-700 pt-8 flex flex-col md:flex-row justify-between items-center">
                <p class="text-sm">&copy; <?php echo e(date('Y')); ?> BluMark. All rights reserved.</p>
                <div class="flex space-x-6 mt-4 md:mt-0 text-sm">
                    <a href="<?php echo e(route('privacy')); ?>" class="hover:text-white transition-colors">Privacy Policy</a>
                    <a href="<?php echo e(route('terms')); ?>" class="hover:text-white transition-colors">Terms of Service</a>
                </div>
            </div>
        </div>
    </footer>
...
<?php /**PATH /var/www/html/watermarking/resources/views/welcome.blade.php ENDPATH**/ ?>