...
<?php $component->withAttributes([]); ?>
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="p-6">
                <?php if($enabled): ?>
                    ...
                    <div class="flex flex-col sm:flex-row gap-3">
                        <a href="<?php echo e(route('two-factor.recovery-codes')); ?>" class="inline-flex items-center justify-center px-5 py-2.5 bg-gray-100 text-gray-700 rounded-xl font-medium text-sm hover:bg-gray-200 transition-colors">
        ...
        <!-- Back to Profile -->
        <div class="mt-6">
            <a href="<?php echo e(route('profile.show')); ?>" class="text-sm text-primary-600 hover:text-primary-500 inline-flex items-center">
...
<?php endif; ?>
<?php /**PATH /var/www/html/watermarking/resources/views/auth/two-factor/show.blade.php ENDPATH**/ ?>