        ...
        <aside class="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 sidebar-gradient">
            ...
            <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
                ...
                <div class="pt-4 mt-4 border-t border-dark-700">
                    ...
                    <a href="<?php echo e(route('batch.index')); ?>"
                       class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors <?php echo e(request()->routeIs('batch.*') ? 'bg-primary-600 text-white' : 'text-gray-400 hover:text-white hover:bg-dark-700'); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="<?php echo e(route('templates.index')); ?>"
                       class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors <?php echo e(request()->routeIs('templates.*') ? 'bg-primary-600 text-white' : 'text-gray-400 hover:text-white hover:bg-dark-700'); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="pt-4 mt-4 border-t border-dark-700">
                    ...
                    <a href="<?php echo e(route('lenders.index')); ?>"
                       class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors <?php echo e(request()->routeIs('lenders.*') ? 'bg-primary-600 text-white' : 'text-gray-400 hover:text-white hover:bg-dark-700'); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="<?php echo e(route('distributions.index')); ?>"
                       class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors <?php echo e(request()->routeIs('distributions.*') ? 'bg-primary-600 text-white' : 'text-gray-400 hover:text-white hover:bg-dark-700'); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="<?php echo e(route('email-templates.index')); ?>"
                       class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors <?php echo e(request()->routeIs('email-templates.*') ? 'bg-primary-600 text-white' : 'text-gray-400 hover:text-white hover:bg-dark-700'); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                        </svg>
                        Email Templates
                    </a>
                    <a href="<?php echo e(route('smtp-settings.index')); ?>"
                       class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors <?php echo e(request()->routeIs('smtp-settings.*') ? 'bg-primary-600 text-white' : 'text-gray-400 hover:text-white hover:bg-dark-700'); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="pt-4 mt-4 border-t border-dark-700">
                    ...
                    <a href="<?php echo e(route('shares.index')); ?>"
                       class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors <?php echo e(request()->routeIs('shares.*') ? 'bg-primary-600 text-white' : 'text-gray-400 hover:text-white hover:bg-dark-700'); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="pt-4 mt-4 border-t border-dark-700">
                    ...
                    <a href="<?php echo e(route('verify.index')); ?>"
                       class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors <?php echo e(request()->routeIs('verify.*') ? 'bg-primary-600 text-white' : 'text-gray-400 hover:text-white hover:bg-dark-700'); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="<?php echo e(route('admin.audit.index')); ?>"
                       class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors <?php echo e(request()->routeIs('admin.audit.*') ? 'bg-primary-600 text-white' : 'text-gray-400 hover:text-white hover:bg-dark-700'); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="<?php echo e(route('admin.ocr.index')); ?>"
                       class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors <?php echo e(request()->routeIs('admin.ocr.*') ? 'bg-primary-600 text-white' : 'text-gray-400 hover:text-white hover:bg-dark-700'); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                ...
                <div class="pt-4 mt-4 border-t border-dark-700">
                    ...
                    <a href="<?php echo e(route('admin.dashboard')); ?>"
                       class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-purple-600 text-white' : 'text-purple-400 hover:text-white hover:bg-purple-900'); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/>
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                        </svg>
            ...
            <div class="p-4 border-t border-dark-700">
                <div x-data="{ open: false }" class="relative">
                    ...
                    <div x-show="open" @click.away="open = false" x-cloak
                        ...
                        <a href="<?php echo e(route('profile.show')); ?>" class="flex items-center w-full px-4 py-3 text-sm text-gray-400 hover:text-white hover:bg-dark-600 transition-colors">
                ...
                <div class="flex items-center justify-between h-16 px-4">
                    ...
                    <div x-data="{ open: false }" class="relative">
                        ...
                        <div x-show="open" @click.away="open = false" x-cloak
                            ...
                            <a href="<?php echo e(route('batch.index')); ?>" class="block px-4 py-3 text-sm text-gray-300 hover:text-white hover:bg-dark-700">Batch Jobs</a>
                            <a href="<?php echo e(route('templates.index')); ?>" class="block px-4 py-3 text-sm text-gray-300 hover:text-white hover:bg-dark-700">Templates</a>
                            <div class="border-t border-dark-700"></div>
                            <p class="px-4 py-2 text-xs font-semibold text-gray-500 uppercase">Submissions</p>
                            <a href="<?php echo e(route('lenders.index')); ?>" class="block px-4 py-3 text-sm text-gray-300 hover:text-white hover:bg-dark-700">Manage Lenders</a>
                            <a href="<?php echo e(route('distributions.index')); ?>" class="block px-4 py-3 text-sm text-gray-300 hover:text-white hover:bg-dark-700">Submissions</a>
                            <a href="<?php echo e(route('email-templates.index')); ?>" class="block px-4 py-3 text-sm text-gray-300 hover:text-white hover:bg-dark-700">Email Templates</a>
                            <a href="<?php echo e(route('smtp-settings.index')); ?>" class="block px-4 py-3 text-sm text-gray-300 hover:text-white hover:bg-dark-700">SMTP Settings</a>
                            <div class="border-t border-dark-700"></div>
                            <p class="px-4 py-2 text-xs font-semibold text-gray-500 uppercase">Sharing</p>
                            <a href="<?php echo e(route('shares.index')); ?>" class="block px-4 py-3 text-sm text-gray-300 hover:text-white hover:bg-dark-700">Shared Links</a>
                            <div class="border-t border-dark-700"></div>
                            <p class="px-4 py-2 text-xs font-semibold text-gray-500 uppercase">Security</p>
                            <a href="<?php echo e(route('verify.index')); ?>" class="block px-4 py-3 text-sm text-gray-300 hover:text-white hover:bg-dark-700">Verify Document</a>
                            <?php if(Auth::check() && Auth::user()->isAdmin()): ?>
                            <a href="<?php echo e(route('admin.audit.index')); ?>" class="block px-4 py-3 text-sm text-gray-300 hover:text-white hover:bg-dark-700">Security Audit</a>
                            <a href="<?php echo e(route('admin.ocr.index')); ?>" class="block px-4 py-3 text-sm text-gray-300 hover:text-white hover:bg-dark-700">OCR Testing</a>
                            <?php endif; ?>
                            <div class="border-t border-dark-700"></div>
                            ...
                            <a href="<?php echo e(route('profile.show')); ?>" class="block px-4 py-3 text-sm text-gray-300 hover:text-white hover:bg-dark-700">My Profile</a>
                            <?php if(Auth::check() && Auth::user()->isAdmin()): ?>
                            <div class="border-t border-dark-700"></div>
                            <p class="px-4 py-2 text-xs font-semibold text-purple-400 uppercase">Admin</p>
                            <a href="<?php echo e(route('admin.dashboard')); ?>" class="block px-4 py-3 text-sm text-purple-300 hover:text-white hover:bg-purple-900">Admin Panel</a>
                            <?php endif; ?>
                            <div class="border-t border-dark-700"></div>
                            <form method="POST" action="<?php echo e(route('logout')); ?>">
                                <?php echo csrf_field(); ?>
