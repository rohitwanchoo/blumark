...
<head>
    ...
    <title>Terms of Service - <?php echo e(config('app.name', 'BluMark')); ?></title>
            ...
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <div class="flex items-center space-x-4">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('dashboard')); ?>" class="inline-flex items-center px-5 py-2.5 bg-primary-600 hover:bg-primary-700 text-white text-sm font-semibold rounded-lg transition-all duration-200">
                            Dashboard
                        </a>
                    <?php else: ?>
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center px-5 py-2.5 bg-primary-600 hover:bg-primary-700 text-white text-sm font-semibold rounded-lg transition-all duration-200">
                            Get Started
                        </a>
                    <?php endif; ?>
                </div>
    ...
    <main class="py-16">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-12">
                ...
                <p class="text-gray-600">Last updated: <?php echo e(date('F j, Y')); ?></p>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 md:p-12 prose prose-gray max-w-none">
                ...
                <p>
                    Uploaded and processed documents are automatically deleted after <strong><?php echo e(config('watermark.retention_days', 7)); ?> days</strong>. You should download your watermarked documents promptly, as we do not maintain backups after the retention period.
                </p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="border-t border-dark-700 pt-8 flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="flex space-x-6 mt-4 md:mt-0 text-sm">
                    ...
                    <a href="<?php echo e(route('terms')); ?>" class="text-primary-400 hover:text-primary-300 transition-colors">Terms of Service</a>
                </div>
            </div>
        </div>
    </footer>
...
<?php /**PATH /var/www/html/watermarking/resources/views/terms.blade.php ENDPATH**/ ?>