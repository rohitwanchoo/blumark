...
<?php $component->withAttributes([]); ?>
                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="w-14 h-14 rounded-xl flex items-center justify-center
                            <?php if($billing['plan_slug'] === 'enterprise'): ?> bg-purple-100
                            <?php elseif($billing['plan_slug'] === 'pro'): ?> bg-primary-100
                            <?php else: ?> bg-gray-100 <?php endif; ?>">
                            <?php if($billing['plan_slug'] === 'enterprise'): ?>
                                <svg class="w-7 h-7 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                                </svg>
                            <?php elseif($billing['plan_slug'] === 'pro'): ?>
                        ...
                        <div>
                            <div class="flex items-center space-x-2">
                                <h3 class="text-lg font-bold text-gray-900"><?php echo e($billing['plan_name']); ?> Plan</h3>
                                <?php if($billing['on_grace_period']): ?>
                            ...
                            <p class="text-sm text-gray-500 mt-0.5">
                                <?php if($billing['jobs_limit'] === null): ?>
                                    Unlimited submissions per month
                                <?php else: ?>
                                    <?php echo e($billing['jobs_limit']); ?> submissions per month
                                <?php endif; ?>
                            </p>
                        </div>
                    </div>
                        ...
                        <?php if($billing['jobs_limit'] !== null): ?>
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <span class="text-sm font-semibold
                                    <?php if($billing['usage_percentage'] >= 90): ?> text-red-600
                                    <?php elseif($billing['usage_percentage'] >= 75): ?> text-yellow-600
                                    <?php else: ?> text-gray-900 <?php endif; ?>">
                                    <?php echo e($billing['jobs_used']); ?> / <?php echo e($billing['jobs_limit']); ?>

                                </span>
                            </div>
                            <div class="w-full bg-gray-200 rounded-full h-3">
                                <div class="h-3 rounded-full transition-all duration-500
                                    <?php if($billing['usage_percentage'] >= 90): ?> bg-red-500
                                    <?php elseif($billing['usage_percentage'] >= 75): ?> bg-yellow-500
                                    <?php else: ?> bg-primary-500 <?php endif; ?>"
                                    style="width: <?php echo e($billing['usage_percentage']); ?>%"></div>
                            </div>
                            <p class="text-xs mt-2">
                                <?php if($billing['total_available'] > 0): ?>
                                    <span class="text-green-600 font-medium"><?php echo e($billing['total_available']); ?> watermark jobs available</span>
                                    <?php if($billing['credits'] > 0): ?>
                                        <span class="text-gray-400">(<?php echo e($billing['jobs_remaining'] ?? 0); ?> plan + <?php echo e($billing['credits']); ?> credits)</span>
                                    <?php endif; ?>
                                <?php else: ?>
                                    <span class="text-red-600 font-medium">No watermark jobs available. <a href="<?php echo e(route('billing.credits')); ?>" class="underline">Buy credits</a></span>
                                <?php endif; ?>
                            </p>
                        <?php else: ?>
                            <div class="flex items-center justify-between mb-2">
                                <span class="text-sm font-medium text-gray-700">Monthly Usage</span>
                                <span class="text-sm font-semibold text-gray-900"><?php echo e($billing['jobs_used']); ?> used</span>
                            </div>
                    ...
                    <div class="flex items-center space-x-4">
                        <?php if($billing['credits'] > 0): ?>
                            <div class="text-center px-4 py-2 bg-green-50 rounded-xl border border-green-100">
                                <p class="text-2xl font-bold text-green-600"><?php echo e($billing['credits']); ?></p>
                                <p class="text-xs text-green-700">Credits</p>
                            </div>
                        <?php endif; ?>

                        <div class="flex flex-col space-y-2">
                            <a href="<?php echo e(route('billing.plans')); ?>" class="inline-flex items-center justify-center px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white text-sm font-semibold rounded-lg transition-colors">
                                    <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"/>
                                    </svg>
                                    <?php echo e(in_array($billing['plan_slug'], ['free', 'pro']) ? 'Upgrade Plan' : 'Manage Plan'); ?>

                                </a>
                            <a href="<?php echo e(route('billing.credits')); ?>" class="inline-flex items-center justify-center px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 text-sm font-medium rounded-lg transition-colors">
                                <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                ...
                <div class="p-6">
                        ...
                        <div class="relative"
                            ...
                            <div class="border-2 border-dashed rounded-xl p-8 text-center transition-all duration-200 cursor-pointer"
                                ...
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-xs text-gray-500 mt-1">Maximum <?php echo e(config('watermark.max_upload_mb')); ?>MB per file</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- ISO Name Warning -->
                    <?php if(empty(Auth::user()->company_name)): ?>
                    <div class="mb-6 p-4 bg-orange-50 rounded-xl border border-orange-200">
                        <div class="flex items-start space-x-2">
                            ...
                            <div class="flex-1">
                                ...
                                <a href="<?php echo e(route('profile.edit')); ?>" class="inline-flex items-center mt-2 text-sm font-medium text-orange-800 hover:text-orange-900">
                                    Update Profile
                    ...
                    <div class="space-y-4 mb-6">
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <a href="<?php echo e(route('profile.edit')); ?>" class="text-xs text-primary-600 hover:text-primary-700 flex items-center">
                    ...
                    <div x-show="successMessage" x-cloak class="mt-4 p-4 bg-green-50 rounded-xl border border-green-100">
                        <div class="flex items-start space-x-2">
                            ...
                            <div>
                                ...
                                <a href="<?php echo e(route('jobs.index')); ?>" class="text-sm text-green-600 hover:text-green-700 underline mt-1 inline-block">View all jobs</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                <div class="px-6 py-5 border-b border-gray-100 flex justify-between items-center">
                    ...
                    <a href="<?php echo e(route('distributions.index')); ?>" class="text-sm text-primary-600 hover:text-primary-700 font-medium flex items-center">
                        View all
                        <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                        </svg>
                ...
                <div class="p-6">
                    <?php if($recentDistributions->isEmpty()): ?>
                        <div class="text-center py-12">
                            ...
                            <a href="<?php echo e(route('distributions.create')); ?>" class="inline-flex items-center px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white text-sm font-medium rounded-lg transition-colors">
                    ...
                    <?php else: ?>
                        <div class="space-y-3">
                            <?php $__currentLoopData = $recentDistributions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $distribution): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route('distributions.show', $distribution)); ?>" class="block p-4 rounded-xl border border-gray-100 hover:border-primary-200 hover:bg-primary-50/50 transition-all duration-200 group">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-3 min-w-0">
                                            ...
                                            <div class="min-w-0">
                                                <p class="text-sm font-medium text-gray-900 truncate"><?php echo e($distribution->name); ?></p>
                                                <p class="text-xs text-gray-500"><?php echo e($distribution->created_at->diffForHumans()); ?></p>
                                            </div>
                                        </div>
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <?php elseif($distribution->status === 'processing' || $distribution->status === 'pending'): ?>
                                    ...
                                    <div class="flex items-center mt-2 text-xs text-gray-500 ml-[52px]">
                                        <span class="flex items-center mr-3">
                                            ...
                                            <?php echo e($distribution->items->unique('lender_id')->count()); ?> <?php echo e(Str::plural('lender', $distribution->items->unique('lender_id')->count())); ?>
                                        ...
                                        <span class="flex items-center">
                                            ...
                                            <?php echo e($distribution->items->count()); ?> <?php echo e(Str::plural('file', $distribution->items->count())); ?>
                                        ...
                                        <?php if($sentCount > 0): ?>
                                            <span class="ml-auto text-green-600 font-medium">
                                                <?php echo e($sentCount); ?>/<?php echo e($distribution->items->count()); ?> sent
                                            </span>
                                        <?php endif; ?>
                                    </div>
                                </a>
    ...
    <script>
        ...
        function watermarkForm() {
            ...
            const maxFileSize = <?php echo e(config('watermark.max_upload_mb', 50)); ?> * 1024 * 1024;
            const csrfToken = '<?php echo e(csrf_token()); ?>';
            const userCompanyName = <?php echo json_encode($user->company_name ?? '', 15, 512) ?>;
            ...
            return {
                ...
                async loadTemplates() {
                    try {
                        const response = await fetch('<?php echo e(route('templates.list')); ?>', {
                ...
                async saveAsTemplate() {
                    ...
                    try {
                        const response = await fetch('<?php echo e(route('templates.quick')); ?>', {
                            method: 'POST',
                            headers: {
                ...
                async startUpload() {
                    ...
                    if (successfulJobs.length > 0) {
                        ...
                        window.location.href = `<?php echo e(route('jobs.batch')); ?>?ids=${jobIds}`;
                    } else if (failCount > 0) {
                ...
                uploadFile(fileItem) {
                    return new Promise((resolve, reject) => {
                        ...
                        xhr.open('POST', '<?php echo e(route('jobs.store')); ?>');
