<x-app-layout>
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-500 mt-1">Update your email template</p>
        </div>
        ...
        <form action="{{ route('email-templates.update', $template) }}" method="POST" x-data="emailTemplateForm()">
            @csrf
            @method('PUT')
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="body"
                                      ...
                                      class="w-full rounded-lg border border-gray-300 bg-white px-4 py-2 focus:border-primary-500 focus:ring-primary-500 focus:outline-none font-mono text-sm"></textarea>
