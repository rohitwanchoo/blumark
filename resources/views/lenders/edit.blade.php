<x-app-layout>
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-500 mt-1">Update lender information</p>
        </div>

        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            <form action="{{ route('lenders.update', $lender) }}" method="POST" class="p-6 space-y-6">
                @csrf
                @method('PUT')
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        <div>
                            ...
                            <input type="text"
                                   name="company_name"
                                   id="company_name"
                                   value="{{ old('company_name', $lender->company_name) }}"
                                   required
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text"
                                   name="first_name"
                                   id="first_name"
                                   value="{{ old('first_name', $lender->first_name) }}"
                        ...
                        <div>
                            ...
                            <input type="text"
                                   name="last_name"
                                   id="last_name"
                                   value="{{ old('last_name', $lender->last_name) }}"
                                   class="w-full rounded-lg border border-gray-300 bg-white px-4 py-2 focus:border-primary-500 focus:ring-primary-500 focus:outline-none">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="email"
                                   name="email_2"
                                   id="email_2"
                                   value="{{ old('email_2', $lender->email_2) }}"
                        ...
                        <div>
                            ...
                            <input type="email"
                                   name="email_3"
                                   id="email_3"
                                   value="{{ old('email_3', $lender->email_3) }}"
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="address"
                                      id="address"
                                      rows="2"
                                      class="w-full rounded-lg border border-gray-300 bg-white px-4 py-2 focus:border-primary-500 focus:ring-primary-500 focus:outline-none">{{ old('address', $lender->address) }}</textarea>
                        </div>
                        <div>
                            ...
                            <textarea name="notes"
                                      id="notes"
                                      rows="3"
                                      class="w-full rounded-lg border border-gray-300 bg-white px-4 py-2 focus:border-primary-500 focus:ring-primary-500 focus:outline-none">{{ old('notes', $lender->notes) }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="border-t border-gray-200 pt-6">
                    ...
                    <label class="flex items-center">
                        <input type="checkbox"
                               name="is_active"
                               value="1"
                               {{ old('is_active', $lender->is_active) ? 'checked' : '' }}
                               class="rounded border-gray-300 text-primary-600 focus:ring-primary-500">
                        <span class="ml-2 text-gray-700">Active (available for distributions)</span>
                    </label>
                </div>
