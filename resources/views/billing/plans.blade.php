    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-12 max-w-3xl">
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white rounded-xl p-4 border border-gray-100">
                    <h3 class="font-medium text-gray-900">What happens to unused jobs?</h3>
                    <p class="mt-1 text-sm text-gray-600">Monthly job allocations reset at the start of each billing period and don't roll over.</p>
                </div>
            </div>
        </div>
    </div>
