<x-app-layout>
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Back Link -->
        <div class="mt-6">
            <a href="{{ route('two-factor.show') }}" class="text-sm text-primary-600 hover:text-primary-500 inline-flex items-center">
    ...
    <script>
        ...
        function downloadRecoveryCodes() {
            ...
            a.href = url;
            a.download = '{{ config("app.name") }}-recovery-codes.txt';
